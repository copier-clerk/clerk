# Specification Quality Checklist: bailiff Single-Module Vertical Slice
...
- **Doc contradictions (High)** → FR-027 broadened to fix all three wrong claims
  (README bare-recopy; README "without trust / action in bailiff"; pyproject "never runs
  actions").
...
reframed bailiff from a published tool into **a skill + copier templates + minimal
...
- FR-010: error surfacing no longer mandates a typed bailiff-error hierarchy; a helper MAY
