...
tree is byte-identical at the recorded commit — matching what `scripts/bailiff.py
reproduce` produces.
...
- **SC-001**: A bailiff-generated project reproduces byte-identically with copier only
