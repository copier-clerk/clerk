...
- **FR-008** *(lifecycle)*: Each module MUST classify each output as **managed** (bailiff owns; re-rendered byte-identically),
...
- **SC-001**: Every consequential tooling decision a competent team differs on is a choice with a sane default; a spot-check
  ...
  is offered.
- **SC-002** *(reworded per critique R5)*: A generated project reproduces with bailiff-managed files byte-identical and
