# Contract — bailiff-mod-readme / -stack-adr / -github-repo / -package-add (NEW)

> **bailiff-mod-org-policy DROPPED from 011** (critique R1): it is inert until an org-source-fetch
...
## bailiff-mod-package-add (monorepo)
