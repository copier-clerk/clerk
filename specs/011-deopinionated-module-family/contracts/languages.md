# Contract — language overlays: bailiff-mod-ts / -go / -rust (NEW)

Shared shape (mirror bailiff-mod-python + [_cross-cutting.md](./_cross-cutting.md)). Each
`run_after: [bailiff-mod-base]`, threads `project_name`. Each contributes its token to the
