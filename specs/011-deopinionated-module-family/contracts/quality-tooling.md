# Contract — bailiff-mod-precommit / -quality / -justfile (NEW)

References [_cross-cutting.md](./_cross-cutting.md). All `run_after: [bailiff-mod-base]`.

## bailiff-mod-precommit — OWNS the hook_manager threading contract (_cross-cutting §4, M1)
...
## bailiff-mod-quality — single-writer language list (kept SEPARATE per maintainer)
...
- `run_after: [bailiff-mod-base]` (+ languages for the list contribution). Single writer, same pattern as gitignore_stack.
