...
- Runs after `clerk-mod-base` (the project must exist before the remote is created).
...
```sh
copier copy https://github.com/copier-clerk/clerk-mod-github-repo.git <destination>
```
