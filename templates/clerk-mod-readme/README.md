...
Runs after `clerk-mod-base`. Threads `project_name`, `description`, and `stack`
...
copier copy https://github.com/copier-clerk/clerk-mod-readme.git <destination> \
...
| `project_name` | str | threaded | Project name (threaded from clerk-mod-base) |
| `description` | str | threaded | One-line description (threaded from clerk-mod-base) |
